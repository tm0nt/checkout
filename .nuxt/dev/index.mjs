...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///home/tassio/checkout/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/tassio/checkout/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/tassio/checkout/node_modules/devalue/index.js';
import destr from 'file:///home/tassio/checkout/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash } from 'file:///home/tassio/checkout/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///home/tassio/checkout/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///home/tassio/checkout/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///home/tassio/checkout/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///home/tassio/checkout/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///home/tassio/checkout/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/tassio/checkout/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///home/tassio/checkout/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///home/tassio/checkout/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///home/tassio/checkout/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///home/tassio/checkout/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/tassio/checkout/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/tassio/checkout/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///home/tassio/checkout/node_modules/consola/dist/index.mjs';
import devalue from 'file:///home/tassio/checkout/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getContext } from 'file:///home/tassio/checkout/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file:///home/tassio/checkout/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///home/tassio/checkout/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/tassio/checkout/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "pwaManifest": {
      "name": "A maior fraternidade do brasil!",
      "short_name": "A maior fraternidade do brasil!",
      "description": "Somos uma fraternidade especializada em desenvolvimento pessoal masculino",
      "lang": "en",
...
const serverAssets = [{"baseName":"server","dir":"/home/tassio/checkout/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/tassio/checkout","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/tassio/checkout/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/tassio/checkout/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/tassio/checkout/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/tassio/checkout/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _3RV7RhZlQJ = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/home/tassio/checkout";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _HJP2Z8j4Yr = (nitroApp) => {
...
const _3yXytsOMbb = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _6eLZBG = defineEventHandler(() => useRuntimeConfig().public.pwaManifest);

const _lazy_ZZUEgb = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_ZZUEgb, lazy: true, middleware: false, method: undefined },
  { route: '/manifest.json', handler: _6eLZBG, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_ZZUEgb, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"hid":"description","name":"description","content":"Somos uma fraternidade especializada em desenvolvimento pessoal masculino"},{"property":"og:site_name","content":"SocialPro"},{"hid":"og:type","property":"og:type","content":"website"},{"hid":"og:url","property":"og:url","content":"https://socialpro.pro"},{"hid":"og:image:secure_url","property":"og:image:secure_url","content":"https://i.imgur.com/TW5cTz0.png"},{"hid":"og:title","property":"og:title","content":"SocialPro"},{"hid":"og:description","property":"og:description","content":"Somos uma fraternidade especializada em desenvolvimento pessoal masculino"},{"hid":"og:image","property":"og:image","content":"https://i.imgur.com/TW5cTz0.png"},{"name":"twitter:card","content":"summary_large_image"},{"hid":"twitter:url","name":"twitter:url","content":"https://socialpro.pro"},{"hid":"twitter:title","name":"twitter:title","content":"SocialPro"},{"hid":"twitter:description","name":"twitter:description","content":"Somos uma fraternidade especializada em desenvolvimento pessoal masculino"},{"hid":"twitter:image","name":"twitter:image","content":"https://i.imgur.com/TW5cTz0.png"},{"name":"mobile-web-app-capable","content":"yes","key":"mobile-web-app-capable"},{"name":"apple-mobile-web-app-title","content":"Social Pro","key":"apple-mobile-web-app-title"},{"name":"author","content":"Tássio Montenegro","key":"author"},{"name":"description","content":"Somos uma fraternidade especializada em desenvolvimento pessoal masculino","key":"description"},{"name":"theme-color","content":"#151515","key":"theme-color"},{"property":"og:type","content":"website","key":"og:type"},{"property":"og:title","content":"Social Pro","key":"og:title"},{"property":"og:site_name","content":"A maior fraternidade do brasil!","key":"og:site_name"},{"property":"og:description","content":"Somos uma fraternidade especializada em desenvolvimento pessoal masculino","key":"og:description"},{"name":"twitter:card","content":"summary","key":"twitter:card"}],"link":[{"rel":"stylesheet","href":"https://rsms.me/inter/inter.css"},{"rel":"preconnect","href":"https://rsms.me/"},{"rel":"icon","type":"image/x-icon","href":"/favicon.png"},{"rel":"canonical","href":"https://socialpro.pro"},{"rel":"icon","href":"/_nuxt/icons/64x64.e9e01ecd.png","key":"favicon"},{"rel":"apple-touch-icon","href":"/_nuxt/icons/512x512.maskable.e9e01ecd.png","sizes":"512x512","key":"favicon-apple"},{"rel":"manifest","href":"/manifest.json"}],"style":[],"script":[],"noscript":[],"title":"Social Pro","titleTemplate":"%s | A maior comunidade do Brasil!","htmlAttrs":{"lang":"en"}};
...
const getClientManifest = () => import('file:///home/tassio/checkout/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/tassio/checkout/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
